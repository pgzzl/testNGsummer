...
@Mapper(
    ...
    name = {"BusinessTripCheckData","BusinessTripCheckDomain","BusinessTripCheckFilterMapper","BusinessTripCheckPostMapper","BusinessTripCheckUpdateMapper","BusinessTripCheckSimpleMapper","BusinessTripCheckDetailMapper",}
)
@MapperExtra(
    value = {"filter","filter","filter","filter","filter","filter","filter","filter","detail",},
    name = {"page","rows","orderBy","statusIn","gmtUpdateFrom","gmtUpdateTo","gmtCreateFrom","gmtCreateTo","user",},
...
@MapperConvert(
    value = {"data","domain",},
    type = {BusinessTripCheckDO.class,BusinessTripCheckTO.class,}
)

public class BusinessTripCheck {
  /**
   * 出差审批ID
   */
  @MapperIgnore({"post",})
