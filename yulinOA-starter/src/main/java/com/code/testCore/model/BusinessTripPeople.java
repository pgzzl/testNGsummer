...
@Mapper(
    ...
    name = {"BusinessTripPeopleData","BusinessTripPeopleDomain","BusinessTripPeopleFilterMapper","BusinessTripPeoplePostMapper","BusinessTripPeopleUpdateMapper","BusinessTripPeopleSimpleMapper","BusinessTripPeopleDetailMapper",}
)
@MapperExtra(
    value = {"filter","filter","filter","filter","filter","filter","filter","detail","detail",},
    name = {"page","rows","orderBy","gmtUpdateFrom","gmtUpdateTo","gmtCreateFrom","gmtCreateTo","businessTrip","user",},
...
@MapperConvert(
    value = {"data","domain",},
    type = {BusinessTripPeopleDO.class,BusinessTripPeopleTO.class,}
)
public class BusinessTripPeople {
  /**
   * 出差同行人ID
   */
  @MapperIgnore({"post",})
