...
@Mapper(
    ...
    name = {"CarParkData","CarParkDomain","CarParkFilterMapper","CarParkPostMapper","CarParkUpdateMapper","CarParkSimpleMapper","CarParkDetailMapper",}
)
@MapperExtra(
    value = {"filter","filter","filter","filter","filter","filter","filter","detail","detail",},
    name = {"page","rows","orderBy","gmtUpdateFrom","gmtUpdateTo","gmtCreateFrom","gmtCreateTo","car","parkPlace",},
...
@MapperConvert(
    value = {"data","domain",},
    type = {CarParkDO.class,CarParkTO.class,}
)
@TestModel
