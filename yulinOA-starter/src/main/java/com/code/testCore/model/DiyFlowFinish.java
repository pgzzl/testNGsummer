...
@Mapper(
    ...
    name = {"DiyFlowFinishData","DiyFlowFinishDomain","DiyFlowFinishFilterMapper","DiyFlowFinishPostMapper","DiyFlowFinishUpdateMapper","DiyFlowFinishSimpleMapper","DiyFlowFinishDetailMapper",}
)
@MapperExtra(
...
@MapperConvert(
    value = {"data","domain",},
    type = {DiyFlowFinishDO.class,DiyFlowFinishTO.class,}
)
@TestModel
public class DiyFlowFinish {
  /**
   * 自定义流程完成ID
   */
  @MapperIgnore({"post",})
