...
@Mapper(
    ...
    name = {"EventData","EventDomain","EventFilterMapper","EventPostMapper","EventUpdateMapper","EventSimpleMapper","EventDetailMapper",}
)
@MapperExtra(
    value = {"filter","filter","filter","filter","filter","filter","filter","detail",},
    name = {"page","rows","orderBy","gmtUpdateFrom","gmtUpdateTo","gmtCreateFrom","gmtCreateTo","eventTask",},
...
@MapperConvert(
    value = {"data","domain",},
    type = {EventDO.class,EventTO.class,}
)
@TestModel
public class Event {
  /**
