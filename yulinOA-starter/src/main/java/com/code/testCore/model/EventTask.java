...
@Mapper(
    ...
    name = {"EventTaskData","EventTaskDomain","EventTaskFilterMapper","EventTaskPostMapper","EventTaskUpdateMapper","EventTaskSimpleMapper","EventTaskDetailMapper",}
)
@MapperExtra(
    value = {"filter","filter","filter","filter","filter","filter","filter","detail",},
    name = {"page","rows","orderBy","gmtUpdateFrom","gmtUpdateTo","gmtCreateFrom","gmtCreateTo","task",},
...
@MapperConvert(
    value = {"data","domain",},
    type = {EventTaskDO.class,EventTaskTO.class,}
)
@TestModel
