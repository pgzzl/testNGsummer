...
@Mapper(
    ...
    name = {"ScheduleItemData","ScheduleItemDomain","ScheduleItemFilterMapper","ScheduleItemPostMapper","ScheduleItemUpdateMapper","ScheduleItemSimpleMapper","ScheduleItemDetailMapper",}
)
@MapperExtra(
    value = {"filter","filter","filter","filter","filter","filter","filter","detail",},
    name = {"page","rows","orderBy","gmtUpdateFrom","gmtUpdateTo","gmtCreateFrom","gmtCreateTo","schedule",},
...
@MapperConvert(
    value = {"data","domain",},
    type = {ScheduleItemDO.class,ScheduleItemTO.class,}
)
@TestModel
