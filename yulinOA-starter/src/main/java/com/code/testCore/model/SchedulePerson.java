...
@Mapper(
    ...
    name = {"SchedulePersonData","SchedulePersonDomain","SchedulePersonFilterMapper","SchedulePersonPostMapper","SchedulePersonUpdateMapper","SchedulePersonSimpleMapper","SchedulePersonDetailMapper",}
)
@MapperExtra(
...
@MapperConvert(
    value = {"data","domain",},
    type = {SchedulePersonDO.class,SchedulePersonTO.class,}
)
@TestModel
