...
@Mapper(
    ...
    name = {"SealApplyCheckManageData","SealApplyCheckManageDomain","SealApplyCheckManageFilterMapper","SealApplyCheckManagePostMapper","SealApplyCheckManageUpdateMapper","SealApplyCheckManageSimpleMapper","SealApplyCheckManageDetailMapper",}
)
@MapperExtra(
    value = {"filter","filter","filter","filter","filter","filter","filter","detail","detail",},
    name = {"page","rows","orderBy","gmtUpdateFrom","gmtUpdateTo","gmtCreateFrom","gmtCreateTo","sealApplyManage","user",},
...
@MapperConvert(
    value = {"data","domain",},
    type = {SealApplyCheckManageDO.class,SealApplyCheckManageTO.class,}
)
@TestModel
public class SealApplyCheckManage {
  /**
   * 印章申请审核ID
   */
  @MapperIgnore({"post",})
