...
public class ArchiveDetailData {
  ...
  public ArchiveDetailData() {
  }

  public ArchiveDetailData(String id, String attachmentUrl, String attachmentName, Date gmtUpdate,
      Date gmtCreate) {
    this.id=id;
  ...
  public static ArchiveDetailData buildMapper(ArchiveDetail obj) {
    ArchiveDetailData mapper = new ArchiveDetailData();
    mapper.id=obj.getId();
  ...
  public static ArchiveDetailDO convert(ArchiveDetail from, ArchiveDetailDO to) {
    if (from == null) return to;
    if (to == null) to = new ArchiveDetailDO();
    to.setId(from.getId());
  ...
  public static ArchiveDetail convert(ArchiveDetailDO from, ArchiveDetail to) {
    if (from == null) return to;
