...
public class ArchiveDetailDefaultMapper {
  public String id;
  ...
  public ArchiveDetailDefaultMapper() {
  }

  public ArchiveDetailDefaultMapper(String id, String attachmentUrl, String attachmentName,
  ...
  public static ArchiveDetailDefaultMapper buildMapper(ArchiveDetail obj) {
    ArchiveDetailDefaultMapper mapper = new ArchiveDetailDefaultMapper();
    mapper.id=obj.getId();
