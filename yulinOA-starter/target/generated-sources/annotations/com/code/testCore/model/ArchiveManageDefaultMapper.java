...
public class ArchiveManageDefaultMapper {
  public String id;
  ...
  public ArchiveManageDefaultMapper() {
  }

  public ArchiveManageDefaultMapper(String id, String name, String department, String description,
  ...
  public static ArchiveManageDefaultMapper buildMapper(ArchiveManage obj) {
    ArchiveManageDefaultMapper mapper = new ArchiveManageDefaultMapper();
    mapper.id=obj.getId();
