...
public class ArchiveManageDetailMapper {
  public String id;
  ...
  public Map archiveDetail = null;

  public ArchiveManageDetailMapper() {
  }

  public ArchiveManageDetailMapper(String id, String name, String department, String description,
  ...
  public static ArchiveManageDetailMapper buildMapper(ArchiveManage obj) {
    ArchiveManageDetailMapper mapper = new ArchiveManageDetailMapper();
    mapper.id=obj.getId();
  ...
  public Map<String, Object> buildMap() {
    ...
    map.put("archiveDetail",this.archiveDetail);
    return map;
  }
  ...
  public static Map<String, Object> buildMapExtra(ArchiveManage obj, Map<String, Object> user,
      Map<String, Object> archiveDetail) {
    Map<String, Object> map = buildMap(obj);
    if (obj == null) return map;
    map.put("user", user);
    map.put("archiveDetail", archiveDetail);
    return map;
  }

  public static Map<String, String> buildSerialMapExtra(ArchiveManage obj, Map<String, Object> user,
      Map<String, Object> archiveDetail) {
    Map<String, String> map = buildSerialMap(obj);
    if (obj == null) return map;
    map.put("user", JSONObject.toJSONString(user));
    map.put("archiveDetail", JSONObject.toJSONString(archiveDetail));
    return map;
  }
}
