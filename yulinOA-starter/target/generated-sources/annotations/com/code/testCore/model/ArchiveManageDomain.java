...
public class ArchiveManageDomain {
  public String id;
  ...
  public ArchiveManageDomain() {
  }

  public ArchiveManageDomain(String id, String name, String department, String description,
  ...
  public static ArchiveManageDomain buildMapper(ArchiveManage obj) {
    ArchiveManageDomain mapper = new ArchiveManageDomain();
    mapper.id=obj.getId();
  ...
  public static ArchiveManageTO convert(ArchiveManage from, ArchiveManageTO to) {
    if (from == null) return to;
    if (to == null) to = new ArchiveManageTO();
    to.setId(from.getId());
  ...
  public static ArchiveManage convert(ArchiveManageTO from, ArchiveManage to) {
    if (from == null) return to;
