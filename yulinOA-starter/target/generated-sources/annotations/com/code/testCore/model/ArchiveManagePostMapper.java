...
public class ArchiveManagePostMapper {
  public String name;
  ...
  public ArchiveManagePostMapper() {
  }

  public ArchiveManagePostMapper(String name, String department, String description,
  ...
  public static ArchiveManagePostMapper buildMapper(ArchiveManage obj) {
    ArchiveManagePostMapper mapper = new ArchiveManagePostMapper();
