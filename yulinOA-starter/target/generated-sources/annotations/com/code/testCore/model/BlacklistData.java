...
public class BlacklistData {
  ...
  public BlacklistData(String id, String operator, Date operateTime, String carId, String reason,
  ...
  public static BlacklistData buildMapper(Blacklist obj) {
    BlacklistData mapper = new BlacklistData();
    mapper.id=obj.getId();
  ...
  public static BlacklistDO convert(Blacklist from, BlacklistDO to) {
    if (from == null) return to;
    if (to == null) to = new BlacklistDO();
    to.setId(from.getId());
  ...
  public static Blacklist convert(BlacklistDO from, Blacklist to) {
    if (from == null) return to;
