...
public class BlacklistSimpleMapper {
  public String id;
  ...
  public BlacklistSimpleMapper() {
  }

  public BlacklistSimpleMapper(String id, String operator, Long operateTime, String carId,
  ...
  public static BlacklistSimpleMapper buildMapper(Blacklist obj) {
    BlacklistSimpleMapper mapper = new BlacklistSimpleMapper();
    mapper.id=obj.getId();
