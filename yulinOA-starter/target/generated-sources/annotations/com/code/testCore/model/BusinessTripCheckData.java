...
import com.horsecoder.yulinOA.sys.dataobject.BusinessTripCheckDO;
...
public class BusinessTripCheckData {
  public String id;
  ...
  public BusinessTripCheckData() {
  }

  public BusinessTripCheckData(String id, String businessTripId, String approverId, Integer status,
  ...
  public static BusinessTripCheckData buildMapper(BusinessTripCheck obj) {
    BusinessTripCheckData mapper = new BusinessTripCheckData();
    mapper.id=obj.getId();
  ...
  public static BusinessTripCheckDO convert(BusinessTripCheck from, BusinessTripCheckDO to) {
    if (from == null) return to;
    if (to == null) to = new BusinessTripCheckDO();
    to.setId(from.getId());
  ...
  public static BusinessTripCheck convert(BusinessTripCheckDO from, BusinessTripCheck to) {
    if (from == null) return to;
