...
public class BusinessTripCheckDetailMapper {
  public String id;
  ...
  public BusinessTripCheckDetailMapper() {
  }

  public BusinessTripCheckDetailMapper(String id, String businessTripId, String approverId,
  ...
  public static BusinessTripCheckDetailMapper buildMapper(BusinessTripCheck obj) {
    BusinessTripCheckDetailMapper mapper = new BusinessTripCheckDetailMapper();
    mapper.id=obj.getId();
  ...
  public static Map<String, Object> buildMapExtra(BusinessTripCheck obj, Map<String, Object> user) {
  ...
  public static Map<String, String> buildSerialMapExtra(BusinessTripCheck obj,
