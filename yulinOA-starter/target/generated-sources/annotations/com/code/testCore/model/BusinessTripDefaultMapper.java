...
public class BusinessTripDefaultMapper {
  public String id;
  ...
  public BusinessTripDefaultMapper() {
  }

  public BusinessTripDefaultMapper(String id, Date tripStartTime, Date tripEndTime,
      String tripStartPlace, String tripEndPlace, String trafficTool, String tripBack,
      String tripRemark, String userId, Integer status, Date gmtUpdate, Date gmtCreate) {
    this.id=id;
  ...
  public static BusinessTripDefaultMapper buildMapper(BusinessTrip obj) {
    BusinessTripDefaultMapper mapper = new BusinessTripDefaultMapper();
    mapper.id=obj.getId();
