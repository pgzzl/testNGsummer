...
public class BusinessTripDomain {
  public String id;
  ...
  public BusinessTripDomain() {
  }

  public BusinessTripDomain(String id, Date tripStartTime, Date tripEndTime, String tripStartPlace,
  ...
  public static BusinessTripDomain buildMapper(BusinessTrip obj) {
    BusinessTripDomain mapper = new BusinessTripDomain();
    mapper.id=obj.getId();
  ...
  public static BusinessTripTO convert(BusinessTrip from, BusinessTripTO to) {
    if (from == null) return to;
    if (to == null) to = new BusinessTripTO();
    to.setId(from.getId());
  ...
  public static BusinessTrip convert(BusinessTripTO from, BusinessTrip to) {
    if (from == null) return to;
