...
import com.horsecoder.yulinOA.sys.dataobject.BusinessTripPeopleDO;
...
public class BusinessTripPeopleData {
  public String id;
  ...
  public BusinessTripPeopleData() {
  }

  public BusinessTripPeopleData(String id, String businessTripId, String userId, Date gmtUpdate,
      Date gmtCreate) {
    this.id=id;
  ...
  public static BusinessTripPeopleData buildMapper(BusinessTripPeople obj) {
    BusinessTripPeopleData mapper = new BusinessTripPeopleData();
    mapper.id=obj.getId();
  ...
  public static BusinessTripPeopleDO convert(BusinessTripPeople from, BusinessTripPeopleDO to) {
    if (from == null) return to;
    if (to == null) to = new BusinessTripPeopleDO();
    to.setId(from.getId());
  ...
  public static BusinessTripPeople convert(BusinessTripPeopleDO from, BusinessTripPeople to) {
    if (from == null) return to;
