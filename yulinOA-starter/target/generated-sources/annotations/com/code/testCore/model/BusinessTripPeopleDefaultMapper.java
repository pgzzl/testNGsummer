...
public class BusinessTripPeopleDefaultMapper {
  public String id;
  ...
  public BusinessTripPeopleDefaultMapper() {
  }

  public BusinessTripPeopleDefaultMapper(String id, String businessTripId, String userId,
  ...
  public static BusinessTripPeopleDefaultMapper buildMapper(BusinessTripPeople obj) {
    BusinessTripPeopleDefaultMapper mapper = new BusinessTripPeopleDefaultMapper();
    mapper.id=obj.getId();
