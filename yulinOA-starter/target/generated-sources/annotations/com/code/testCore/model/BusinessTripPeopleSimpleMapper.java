...
public class BusinessTripPeopleSimpleMapper {
  public String id;
  ...
  public BusinessTripPeopleSimpleMapper() {
  }

  public BusinessTripPeopleSimpleMapper(String id, String businessTripId, String userId,
  ...
  public static BusinessTripPeopleSimpleMapper buildMapper(BusinessTripPeople obj) {
    BusinessTripPeopleSimpleMapper mapper = new BusinessTripPeopleSimpleMapper();
    mapper.id=obj.getId();
