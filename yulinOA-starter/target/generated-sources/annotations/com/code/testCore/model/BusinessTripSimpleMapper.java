...
public class BusinessTripSimpleMapper {
  public String id;
  ...
  public BusinessTripSimpleMapper() {
  }

  public BusinessTripSimpleMapper(String id, Long tripStartTime, Long tripEndTime,
  ...
  public static BusinessTripSimpleMapper buildMapper(BusinessTrip obj) {
    BusinessTripSimpleMapper mapper = new BusinessTripSimpleMapper();
    mapper.id=obj.getId();
