...
public class CarDefaultMapper {
  ...
  public CarDefaultMapper() {
  }

  public CarDefaultMapper(String id, String driverName, String driverPhone, String carID,
      String parkType, String carState, Date stopTime, String enterpriseId, Date gmtUpdate,
      Date gmtCreate) {
    this.id=id;
  ...
  public static CarDefaultMapper buildMapper(Car obj) {
    CarDefaultMapper mapper = new CarDefaultMapper();
    mapper.id=obj.getId();
