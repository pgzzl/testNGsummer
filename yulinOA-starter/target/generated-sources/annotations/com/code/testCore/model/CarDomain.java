...
public class CarDomain {
  ...
  public CarDomain(String id, String driverName, String driverPhone, String carID, String parkType,
  ...
  public static CarDomain buildMapper(Car obj) {
    CarDomain mapper = new CarDomain();
    mapper.id=obj.getId();
  ...
  public static CarTO convert(Car from, CarTO to) {
    if (from == null) return to;
    if (to == null) to = new CarTO();
    to.setId(from.getId());
  ...
  public static Car convert(CarTO from, Car to) {
    if (from == null) return to;
