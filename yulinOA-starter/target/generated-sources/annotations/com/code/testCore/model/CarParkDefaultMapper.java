...
public class CarParkDefaultMapper {
  public String id;
  ...
  public CarParkDefaultMapper() {
  }

  public CarParkDefaultMapper(String id, Integer status, String time, String carId,
      String parkPlaceId, Date gmtUpdate, Date gmtCreate) {
    this.id=id;
    this.status=status;
    this.time=time;
    this.carId=carId;
  ...
  public static CarParkDefaultMapper buildMapper(CarPark obj) {
    CarParkDefaultMapper mapper = new CarParkDefaultMapper();
    mapper.id=obj.getId();
