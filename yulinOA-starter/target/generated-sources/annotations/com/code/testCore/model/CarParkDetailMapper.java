...
public class CarParkDetailMapper {
  public String id;
  ...
  public Map parkPlace = null;

  public CarParkDetailMapper() {
  }

  public CarParkDetailMapper(String id, Integer status, String time, String carId,
  ...
  public static CarParkDetailMapper buildMapper(CarPark obj) {
    CarParkDetailMapper mapper = new CarParkDetailMapper();
    mapper.id=obj.getId();
  ...
  public Map<String, Object> buildMap() {
    ...
    map.put("parkPlace",this.parkPlace);
    return map;
  }
  ...
  public static Map<String, Object> buildMapExtra(CarPark obj, Map<String, Object> car,
      Map<String, Object> parkPlace) {
  ...
  public static Map<String, String> buildSerialMapExtra(CarPark obj, Map<String, Object> car,
      Map<String, Object> parkPlace) {
    Map<String, String> map = buildSerialMap(obj);
    if (obj == null) return map;
    map.put("car", JSONObject.toJSONString(car));
    map.put("parkPlace", JSONObject.toJSONString(parkPlace));
    return map;
  }
}
