...
import com.horsecoder.yulinOA.sys.domain.CarParkTO;
...
public class CarParkDomain {
  ...
  public CarParkDomain() {
  }

  public CarParkDomain(String id, Integer status, String time, String carId, String parkPlaceId,
  ...
  public static CarParkDomain buildMapper(CarPark obj) {
    CarParkDomain mapper = new CarParkDomain();
    mapper.id=obj.getId();
  ...
  public static CarParkTO convert(CarPark from, CarParkTO to) {
    if (from == null) return to;
    if (to == null) to = new CarParkTO();
    to.setId(from.getId());
  ...
  public static CarPark convert(CarParkTO from, CarPark to) {
    if (from == null) return to;
