...
public class CarPostMapper {
  ...
  public CarPostMapper() {
  }

  public CarPostMapper(String driverName, String driverPhone, String carID, String parkType,
      String carState, String enterpriseId) {
  ...
  public static CarPostMapper buildMapper(Car obj) {
    CarPostMapper mapper = new CarPostMapper();
