...
public class CarSimpleMapper {
  ...
  public CarSimpleMapper() {
  }

  public CarSimpleMapper(String id, String driverName, String driverPhone, String carID,
  ...
  public static CarSimpleMapper buildMapper(Car obj) {
    CarSimpleMapper mapper = new CarSimpleMapper();
    mapper.id=obj.getId();
