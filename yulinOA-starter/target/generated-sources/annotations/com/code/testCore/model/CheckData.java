...
public class CheckData {
  ...
  public CheckData(String id, String eventId, Integer status, Integer type, Date gmtUpdate,
      Date gmtCreate) {
    this.id=id;
  ...
  public static CheckData buildMapper(Check obj) {
    CheckData mapper = new CheckData();
    mapper.id=obj.getId();
  ...
  public static CheckDO convert(Check from, CheckDO to) {
    if (from == null) return to;
    if (to == null) to = new CheckDO();
    to.setId(from.getId());
  ...
  public static Check convert(CheckDO from, Check to) {
    if (from == null) return to;
