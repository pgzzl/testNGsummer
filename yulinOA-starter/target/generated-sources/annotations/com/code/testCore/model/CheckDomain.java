...
public class CheckDomain {
  ...
  public CheckDomain(String id, String eventId, Integer status, Integer type, Date gmtUpdate,
      Date gmtCreate) {
    this.id=id;
  ...
  public static CheckDomain buildMapper(Check obj) {
    CheckDomain mapper = new CheckDomain();
    mapper.id=obj.getId();
  ...
  public static CheckTO convert(Check from, CheckTO to) {
    if (from == null) return to;
    if (to == null) to = new CheckTO();
    to.setId(from.getId());
  ...
  public static Check convert(CheckTO from, Check to) {
    if (from == null) return to;
    if (to == null) to = new Check();
    to.setId(from.getId());
    to.setEventId(from.getEventId());
    to.setStatus(from.getStatus());
    to.setType(from.getType());
