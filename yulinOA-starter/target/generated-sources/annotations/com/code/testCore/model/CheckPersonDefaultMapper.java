...
public class CheckPersonDefaultMapper {
  public String id;
  ...
  public CheckPersonDefaultMapper() {
  }

  public CheckPersonDefaultMapper(String id, String checkId, Integer status, String userId,
  ...
  public static CheckPersonDefaultMapper buildMapper(CheckPerson obj) {
    CheckPersonDefaultMapper mapper = new CheckPersonDefaultMapper();
    mapper.id=obj.getId();
