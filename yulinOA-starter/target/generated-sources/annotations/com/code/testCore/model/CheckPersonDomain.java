...
public class CheckPersonDomain {
  public String id;
  ...
  public CheckPersonDomain() {
  }

  public CheckPersonDomain(String id, String checkId, Integer status, String userId, Date gmtUpdate,
      Date gmtCreate) {
    this.id=id;
  ...
  public static CheckPersonDomain buildMapper(CheckPerson obj) {
    CheckPersonDomain mapper = new CheckPersonDomain();
    mapper.id=obj.getId();
  ...
  public static CheckPersonTO convert(CheckPerson from, CheckPersonTO to) {
    if (from == null) return to;
    if (to == null) to = new CheckPersonTO();
    to.setId(from.getId());
  ...
  public static CheckPerson convert(CheckPersonTO from, CheckPerson to) {
    if (from == null) return to;
