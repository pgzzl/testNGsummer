...
public class CheckPersonSimpleMapper {
  public String id;
  ...
  public CheckPersonSimpleMapper() {
  }

  public CheckPersonSimpleMapper(String id, String checkId, Integer status, String userId,
  ...
  public static CheckPersonSimpleMapper buildMapper(CheckPerson obj) {
    CheckPersonSimpleMapper mapper = new CheckPersonSimpleMapper();
    mapper.id=obj.getId();
