...
public class CheckSimpleMapper {
  public String id;
  ...
  public CheckSimpleMapper() {
  }

  public CheckSimpleMapper(String id, String eventId, Integer status, Integer type, Long gmtUpdate,
      Long gmtCreate) {
    this.id=id;
  ...
  public static CheckSimpleMapper buildMapper(Check obj) {
    CheckSimpleMapper mapper = new CheckSimpleMapper();
    mapper.id=obj.getId();
