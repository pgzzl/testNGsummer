...
public class CustomScheduleDefaultMapper {
  public String id;
  ...
  public CustomScheduleDefaultMapper() {
  }

  public CustomScheduleDefaultMapper(String id, String title, Date time, String address,
      String remark, Date gmtUpdate, Date gmtCreate) {
    this.id=id;
    this.title=title;
    this.time=time;
  ...
  public static CustomScheduleDefaultMapper buildMapper(CustomSchedule obj) {
    CustomScheduleDefaultMapper mapper = new CustomScheduleDefaultMapper();
    mapper.id=obj.getId();
