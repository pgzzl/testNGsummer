...
public class CustomScheduleDetailMapper {
  public String id;
  ...
  public CustomScheduleDetailMapper() {
  }

  public CustomScheduleDetailMapper(String id, String title, Long time, String address,
  ...
  public static CustomScheduleDetailMapper buildMapper(CustomSchedule obj) {
    CustomScheduleDetailMapper mapper = new CustomScheduleDetailMapper();
    mapper.id=obj.getId();
