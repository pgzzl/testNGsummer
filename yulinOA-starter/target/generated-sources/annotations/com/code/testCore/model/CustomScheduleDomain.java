...
public class CustomScheduleDomain {
  public String id;
  ...
  public CustomScheduleDomain() {
  }

  public CustomScheduleDomain(String id, String title, Date time, String address, String remark,
  ...
  public static CustomScheduleDomain buildMapper(CustomSchedule obj) {
    CustomScheduleDomain mapper = new CustomScheduleDomain();
    mapper.id=obj.getId();
  ...
  public static CustomScheduleTO convert(CustomSchedule from, CustomScheduleTO to) {
    if (from == null) return to;
    if (to == null) to = new CustomScheduleTO();
    to.setId(from.getId());
  ...
  public static CustomSchedule convert(CustomScheduleTO from, CustomSchedule to) {
    if (from == null) return to;
