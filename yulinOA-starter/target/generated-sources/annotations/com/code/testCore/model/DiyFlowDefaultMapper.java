...
public class DiyFlowDefaultMapper {
  public String id;
  ...
  public DiyFlowDefaultMapper() {
  }

  public DiyFlowDefaultMapper(String id, String url, String name, String person, Date gmtUpdate,
      Date gmtCreate) {
    this.id=id;
    this.url=url;
    this.name=name;
  ...
  public static DiyFlowDefaultMapper buildMapper(DiyFlow obj) {
    DiyFlowDefaultMapper mapper = new DiyFlowDefaultMapper();
    mapper.id=obj.getId();
