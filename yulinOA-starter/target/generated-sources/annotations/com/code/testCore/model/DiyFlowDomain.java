...
public class DiyFlowDomain {
  ...
  public DiyFlowDomain() {
  }

  public DiyFlowDomain(String id, String url, String name, String person, Date gmtUpdate,
      Date gmtCreate) {
    this.id=id;
    this.url=url;
    this.name=name;
  ...
  public static DiyFlowDomain buildMapper(DiyFlow obj) {
    DiyFlowDomain mapper = new DiyFlowDomain();
    mapper.id=obj.getId();
  ...
  public static DiyFlowTO convert(DiyFlow from, DiyFlowTO to) {
    if (from == null) return to;
    if (to == null) to = new DiyFlowTO();
    to.setId(from.getId());
  ...
  public static DiyFlow convert(DiyFlowTO from, DiyFlow to) {
    if (from == null) return to;
