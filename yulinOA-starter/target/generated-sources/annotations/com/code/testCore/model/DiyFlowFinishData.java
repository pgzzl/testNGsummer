...
import com.horsecoder.yulinOA.sys.dataobject.DiyFlowFinishDO;
...
public class DiyFlowFinishData {
  public String id;
  ...
  public DiyFlowFinishData() {
  }

  public DiyFlowFinishData(String id, String diyFlowId, Integer status, Date gmtUpdate,
      Date gmtCreate) {
    this.id=id;
  ...
  public static DiyFlowFinishData buildMapper(DiyFlowFinish obj) {
    DiyFlowFinishData mapper = new DiyFlowFinishData();
    mapper.id=obj.getId();
  ...
  public static DiyFlowFinishDO convert(DiyFlowFinish from, DiyFlowFinishDO to) {
    if (from == null) return to;
    if (to == null) to = new DiyFlowFinishDO();
    to.setId(from.getId());
  ...
  public static DiyFlowFinish convert(DiyFlowFinishDO from, DiyFlowFinish to) {
    if (from == null) return to;
