...
public class DiyFlowFinishDefaultMapper {
  public String id;
  ...
  public DiyFlowFinishDefaultMapper() {
  }

  public DiyFlowFinishDefaultMapper(String id, String diyFlowId, Integer status, Date gmtUpdate,
      Date gmtCreate) {
    this.id=id;
  ...
  public static DiyFlowFinishDefaultMapper buildMapper(DiyFlowFinish obj) {
    DiyFlowFinishDefaultMapper mapper = new DiyFlowFinishDefaultMapper();
    mapper.id=obj.getId();
