...
public class DiyFlowFinishDetailMapper {
  public String id;
  ...
  public DiyFlowFinishDetailMapper() {
  }

  public DiyFlowFinishDetailMapper(String id, String diyFlowId, Integer status, Long gmtUpdate,
      Long gmtCreate) {
    this.id=id;
  ...
  public static DiyFlowFinishDetailMapper buildMapper(DiyFlowFinish obj) {
    DiyFlowFinishDetailMapper mapper = new DiyFlowFinishDetailMapper();
    mapper.id=obj.getId();
