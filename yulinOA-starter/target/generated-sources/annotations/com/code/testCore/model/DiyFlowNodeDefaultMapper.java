...
public class DiyFlowNodeDefaultMapper {
  public String id;
  ...
  public DiyFlowNodeDefaultMapper() {
  }

  public DiyFlowNodeDefaultMapper(String id, Integer type, String title, String diyFlowId,
  ...
  public static DiyFlowNodeDefaultMapper buildMapper(DiyFlowNode obj) {
    DiyFlowNodeDefaultMapper mapper = new DiyFlowNodeDefaultMapper();
    mapper.id=obj.getId();
