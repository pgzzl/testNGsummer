...
public class DiyFlowNodeDomain {
  public String id;
  ...
  public DiyFlowNodeDomain() {
  }

  public DiyFlowNodeDomain(String id, Integer type, String title, String diyFlowId, Date gmtUpdate,
      Date gmtCreate) {
    this.id=id;
    this.type=type;
    this.title=title;
  ...
  public static DiyFlowNodeDomain buildMapper(DiyFlowNode obj) {
    DiyFlowNodeDomain mapper = new DiyFlowNodeDomain();
    mapper.id=obj.getId();
  ...
  public static DiyFlowNodeTO convert(DiyFlowNode from, DiyFlowNodeTO to) {
    if (from == null) return to;
    if (to == null) to = new DiyFlowNodeTO();
    to.setId(from.getId());
  ...
  public static DiyFlowNode convert(DiyFlowNodeTO from, DiyFlowNode to) {
    if (from == null) return to;
