...
public class DiyFlowNodeSimpleMapper {
  public String id;
  ...
  public DiyFlowNodeSimpleMapper() {
  }

  public DiyFlowNodeSimpleMapper(String id, Integer type, String title, String diyFlowId,
  ...
  public static DiyFlowNodeSimpleMapper buildMapper(DiyFlowNode obj) {
    DiyFlowNodeSimpleMapper mapper = new DiyFlowNodeSimpleMapper();
    mapper.id=obj.getId();
