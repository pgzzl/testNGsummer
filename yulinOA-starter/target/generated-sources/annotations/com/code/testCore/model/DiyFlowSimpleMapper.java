...
public class DiyFlowSimpleMapper {
  public String id;
  ...
  public DiyFlowSimpleMapper() {
  }

  public DiyFlowSimpleMapper(String id, String url, String name, String person, Long gmtUpdate,
      Long gmtCreate) {
    this.id=id;
    this.url=url;
    this.name=name;
  ...
  public static DiyFlowSimpleMapper buildMapper(DiyFlow obj) {
    DiyFlowSimpleMapper mapper = new DiyFlowSimpleMapper();
    mapper.id=obj.getId();
