...
public class DiyFlowTextData {
  ...
  public DiyFlowTextData() {
  }

  public DiyFlowTextData(String id, String title, Integer type, String diyFlowId, Date gmtUpdate,
      Date gmtCreate) {
    this.id=id;
    this.title=title;
    this.type=type;
  ...
  public static DiyFlowTextData buildMapper(DiyFlowText obj) {
    DiyFlowTextData mapper = new DiyFlowTextData();
    mapper.id=obj.getId();
  ...
  public static DiyFlowTextDO convert(DiyFlowText from, DiyFlowTextDO to) {
    if (from == null) return to;
    if (to == null) to = new DiyFlowTextDO();
    to.setId(from.getId());
  ...
  public static DiyFlowText convert(DiyFlowTextDO from, DiyFlowText to) {
    if (from == null) return to;
