...
public class DiyFlowTextDetailMapper {
  public String id;
  ...
  public DiyFlowTextDetailMapper() {
  }

  public DiyFlowTextDetailMapper(String id, String title, Integer type, String diyFlowId,
  ...
  public static DiyFlowTextDetailMapper buildMapper(DiyFlowText obj) {
    DiyFlowTextDetailMapper mapper = new DiyFlowTextDetailMapper();
    mapper.id=obj.getId();
