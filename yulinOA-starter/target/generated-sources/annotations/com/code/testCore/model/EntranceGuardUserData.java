...
public class EntranceGuardUserData {
  public String id;
  ...
  public EntranceGuardUserData() {
  }

  public EntranceGuardUserData(String id, Integer visitorType, String belongCompany,
  ...
  public static EntranceGuardUserData buildMapper(EntranceGuardUser obj) {
    EntranceGuardUserData mapper = new EntranceGuardUserData();
    mapper.id=obj.getId();
  ...
  public static EntranceGuardUserDO convert(EntranceGuardUser from, EntranceGuardUserDO to) {
    if (from == null) return to;
    if (to == null) to = new EntranceGuardUserDO();
    to.setId(from.getId());
  ...
  public static EntranceGuardUser convert(EntranceGuardUserDO from, EntranceGuardUser to) {
    if (from == null) return to;
