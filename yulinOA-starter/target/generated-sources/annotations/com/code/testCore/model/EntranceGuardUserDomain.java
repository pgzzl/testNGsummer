...
public class EntranceGuardUserDomain {
  public String id;
  ...
  public EntranceGuardUserDomain() {
  }

  public EntranceGuardUserDomain(String id, Integer visitorType, String belongCompany,
  ...
  public static EntranceGuardUserDomain buildMapper(EntranceGuardUser obj) {
    EntranceGuardUserDomain mapper = new EntranceGuardUserDomain();
    mapper.id=obj.getId();
  ...
  public static EntranceGuardUserTO convert(EntranceGuardUser from, EntranceGuardUserTO to) {
    if (from == null) return to;
    if (to == null) to = new EntranceGuardUserTO();
    to.setId(from.getId());
    to.setVisitorType(from.getVisitorType());
    to.setBelongCompany(from.getBelongCompany());
    to.setInParkTime(from.getInParkTime());
    to.setEntranceUserName(from.getEntranceUserName());
    to.setEntranceScope(from.getEntranceScope());
    to.setOutParkTime(from.getOutParkTime());
    to.setEntranceManagementId(from.getEntranceManagementId());
    to.setEntrancePhone(from.getEntrancePhone());
    to.setEntranceRemark(from.getEntranceRemark());
    to.setEntranceRecord(from.getEntranceRecord());
    to.setApplyState(from.getApplyState());
    to.setQrCode(from.getQrCode());
    to.setEntranceCardId(from.getEntranceCardId());
    to.setExamineRemark(from.getExamineRemark());
  ...
  public static EntranceGuardUser convert(EntranceGuardUserTO from, EntranceGuardUser to) {
    if (from == null) return to;
    if (to == null) to = new EntranceGuardUser();
    to.setId(from.getId());
    to.setVisitorType(from.getVisitorType());
    to.setBelongCompany(from.getBelongCompany());
    to.setInParkTime(from.getInParkTime());
