...
public class EntranceGuardUserPostMapper {
  ...
  public EntranceGuardUserPostMapper() {
  }

  public EntranceGuardUserPostMapper(Integer visitorType, String belongCompany, Long inParkTime,
      String entranceUserName, String entranceScope, Long outParkTime, String entrancePhone,
      String entranceRemark, String entranceRecord, Integer applyState, String qrCode,
      String entranceCardId, String examineRemark, String userId) {
  ...
  public static EntranceGuardUserPostMapper buildMapper(EntranceGuardUser obj) {
    EntranceGuardUserPostMapper mapper = new EntranceGuardUserPostMapper();
