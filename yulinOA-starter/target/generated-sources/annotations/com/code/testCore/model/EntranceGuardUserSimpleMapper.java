...
public class EntranceGuardUserSimpleMapper {
  public String id;
  ...
  public EntranceGuardUserSimpleMapper() {
  }

  public EntranceGuardUserSimpleMapper(String id, Integer visitorType, String belongCompany,
  ...
  public static EntranceGuardUserSimpleMapper buildMapper(EntranceGuardUser obj) {
    EntranceGuardUserSimpleMapper mapper = new EntranceGuardUserSimpleMapper();
    mapper.id=obj.getId();
