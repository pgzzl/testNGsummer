...
public class EntranceHistoryData {
  public String id;
  ...
  public EntranceHistoryData() {
  }

  public EntranceHistoryData(String id, String entranceGuardId, String staffName, String tellPhone,
      Date useDate, Integer inOrOut, String entranceName, String photo, Date gmtUpdate,
      Date gmtCreate) {
    this.id=id;
  ...
  public static EntranceHistoryData buildMapper(EntranceHistory obj) {
    EntranceHistoryData mapper = new EntranceHistoryData();
    mapper.id=obj.getId();
  ...
  public static EntranceHistoryDO convert(EntranceHistory from, EntranceHistoryDO to) {
    if (from == null) return to;
    if (to == null) to = new EntranceHistoryDO();
    to.setId(from.getId());
    to.setEntranceGuardId(from.getEntranceGuardId());
    to.setStaffName(from.getStaffName());
    to.setTellPhone(from.getTellPhone());
    to.setUseDate(from.getUseDate());
  ...
  public static EntranceHistory convert(EntranceHistoryDO from, EntranceHistory to) {
    if (from == null) return to;
    if (to == null) to = new EntranceHistory();
    to.setId(from.getId());
    to.setEntranceGuardId(from.getEntranceGuardId());
    to.setStaffName(from.getStaffName());
    to.setTellPhone(from.getTellPhone());
