...
public class EntranceHistoryDomain {
  public String id;
  ...
  public EntranceHistoryDomain() {
  }

  public EntranceHistoryDomain(String id, String entranceGuardId, String staffName,
  ...
  public static EntranceHistoryDomain buildMapper(EntranceHistory obj) {
    EntranceHistoryDomain mapper = new EntranceHistoryDomain();
    mapper.id=obj.getId();
  ...
  public static EntranceHistoryTO convert(EntranceHistory from, EntranceHistoryTO to) {
    if (from == null) return to;
    if (to == null) to = new EntranceHistoryTO();
    to.setId(from.getId());
  ...
  public static EntranceHistory convert(EntranceHistoryTO from, EntranceHistory to) {
    if (from == null) return to;
