...
public class EntranceHistorySimpleMapper {
  public String id;
  ...
  public EntranceHistorySimpleMapper() {
  }

  public EntranceHistorySimpleMapper(String id, String entranceGuardId, String staffName,
  ...
  public static EntranceHistorySimpleMapper buildMapper(EntranceHistory obj) {
    EntranceHistorySimpleMapper mapper = new EntranceHistorySimpleMapper();
    mapper.id=obj.getId();
