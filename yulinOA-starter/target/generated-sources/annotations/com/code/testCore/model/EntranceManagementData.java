...
public class EntranceManagementData {
  public String id;
  ...
  public EntranceManagementData() {
  }

  public EntranceManagementData(String id, String entranceName, String inOrOut, String address,
  ...
  public static EntranceManagementData buildMapper(EntranceManagement obj) {
    EntranceManagementData mapper = new EntranceManagementData();
    mapper.id=obj.getId();
  ...
  public static EntranceManagementDO convert(EntranceManagement from, EntranceManagementDO to) {
    if (from == null) return to;
    if (to == null) to = new EntranceManagementDO();
    to.setId(from.getId());
  ...
  public static EntranceManagement convert(EntranceManagementDO from, EntranceManagement to) {
    if (from == null) return to;
