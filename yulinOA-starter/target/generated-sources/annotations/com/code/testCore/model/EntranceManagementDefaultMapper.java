...
public class EntranceManagementDefaultMapper {
  public String id;
  ...
  public EntranceManagementDefaultMapper() {
  }

  public EntranceManagementDefaultMapper(String id, String entranceName, String inOrOut,
      String address, Integer useNum, String belongBuilding, Date gmtUpdate, Date gmtCreate) {
    this.id=id;
  ...
  public static EntranceManagementDefaultMapper buildMapper(EntranceManagement obj) {
    EntranceManagementDefaultMapper mapper = new EntranceManagementDefaultMapper();
    mapper.id=obj.getId();
