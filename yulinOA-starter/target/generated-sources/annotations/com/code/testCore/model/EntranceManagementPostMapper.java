...
public class EntranceManagementPostMapper {
  ...
  public EntranceManagementPostMapper() {
  }

  public EntranceManagementPostMapper(String entranceName, String inOrOut, String address,
      Integer useNum, String belongBuilding) {
  ...
  public static EntranceManagementPostMapper buildMapper(EntranceManagement obj) {
    EntranceManagementPostMapper mapper = new EntranceManagementPostMapper();
