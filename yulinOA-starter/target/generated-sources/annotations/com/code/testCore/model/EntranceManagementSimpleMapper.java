...
public class EntranceManagementSimpleMapper {
  public String id;
  ...
  public EntranceManagementSimpleMapper() {
  }

  public EntranceManagementSimpleMapper(String id, String entranceName, String inOrOut,
  ...
  public static EntranceManagementSimpleMapper buildMapper(EntranceManagement obj) {
    EntranceManagementSimpleMapper mapper = new EntranceManagementSimpleMapper();
    mapper.id=obj.getId();
