...
import com.horsecoder.yulinOA.sys.domain.EventTO;
...
public class EventDomain {
  ...
  public EventDomain(String id, String type, String status, String name, Date gmtUpdate,
      Date gmtCreate) {
    this.id=id;
    this.type=type;
    this.status=status;
  ...
  public static EventDomain buildMapper(Event obj) {
    EventDomain mapper = new EventDomain();
    mapper.id=obj.getId();
  ...
  public static EventTO convert(Event from, EventTO to) {
    if (from == null) return to;
    if (to == null) to = new EventTO();
    to.setId(from.getId());
  ...
  public static Event convert(EventTO from, Event to) {
    if (from == null) return to;
