...
import com.horsecoder.yulinOA.sys.dataobject.EventTaskDO;
...
public class EventTaskData {
  ...
  public EventTaskData(String id, String eventId, String taskId, Date gmtUpdate, Date gmtCreate) {
    this.id=id;
  ...
  public static EventTaskData buildMapper(EventTask obj) {
    EventTaskData mapper = new EventTaskData();
    mapper.id=obj.getId();
  ...
  public static EventTaskDO convert(EventTask from, EventTaskDO to) {
    if (from == null) return to;
    if (to == null) to = new EventTaskDO();
    to.setId(from.getId());
  ...
  public static EventTask convert(EventTaskDO from, EventTask to) {
    if (from == null) return to;
