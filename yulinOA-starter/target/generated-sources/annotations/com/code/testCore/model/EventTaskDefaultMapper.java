...
public class EventTaskDefaultMapper {
  public String id;
  ...
  public EventTaskDefaultMapper() {
  }

  public EventTaskDefaultMapper(String id, String eventId, String taskId, Date gmtUpdate,
      Date gmtCreate) {
    this.id=id;
  ...
  public static EventTaskDefaultMapper buildMapper(EventTask obj) {
    EventTaskDefaultMapper mapper = new EventTaskDefaultMapper();
    mapper.id=obj.getId();
