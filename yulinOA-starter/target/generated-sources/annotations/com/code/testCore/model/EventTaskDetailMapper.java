...
public class EventTaskDetailMapper {
  public String id;
  ...
  public Map task = null;

  public EventTaskDetailMapper() {
  }

  public EventTaskDetailMapper(String id, String eventId, String taskId, Long gmtUpdate,
      Long gmtCreate) {
    this.id=id;
  ...
  public static EventTaskDetailMapper buildMapper(EventTask obj) {
    EventTaskDetailMapper mapper = new EventTaskDetailMapper();
    mapper.id=obj.getId();
  ...
  public static Map<String, Object> buildMapExtra(EventTask obj, Map<String, Object> task) {
  ...
  public static Map<String, String> buildSerialMapExtra(EventTask obj, Map<String, Object> task) {
