...
public class GroupData {
  ...
  public GroupData(String id, String headImg, String groupName, String groupPeople, Date gmtUpdate,
      Date gmtCreate) {
    this.id=id;
  ...
  public static GroupData buildMapper(Group obj) {
    GroupData mapper = new GroupData();
    mapper.id=obj.getId();
  ...
  public static GroupDO convert(Group from, GroupDO to) {
    if (from == null) return to;
    if (to == null) to = new GroupDO();
    to.setId(from.getId());
  ...
  public static Group convert(GroupDO from, Group to) {
    if (from == null) return to;
