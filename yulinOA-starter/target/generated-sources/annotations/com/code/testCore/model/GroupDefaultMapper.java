...
public class GroupDefaultMapper {
  public String id;
  ...
  public GroupDefaultMapper() {
  }

  public GroupDefaultMapper(String id, String headImg, String groupName, String groupPeople,
  ...
  public static GroupDefaultMapper buildMapper(Group obj) {
    GroupDefaultMapper mapper = new GroupDefaultMapper();
    mapper.id=obj.getId();
