...
public class GroupDetailMapper {
  ...
  public GroupDetailMapper() {
  }

  public GroupDetailMapper(String id, String headImg, String groupName, String groupPeople,
  ...
  public static GroupDetailMapper buildMapper(Group obj) {
    GroupDetailMapper mapper = new GroupDetailMapper();
    mapper.id=obj.getId();
