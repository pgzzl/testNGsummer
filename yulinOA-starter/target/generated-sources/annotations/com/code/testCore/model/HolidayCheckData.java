...
public class HolidayCheckData {
  ...
  public HolidayCheckData() {
  }

  public HolidayCheckData(String id, String holidayId, String approverId, Integer status,
  ...
  public static HolidayCheckData buildMapper(HolidayCheck obj) {
    HolidayCheckData mapper = new HolidayCheckData();
    mapper.id=obj.getId();
  ...
  public static HolidayCheckDO convert(HolidayCheck from, HolidayCheckDO to) {
    if (from == null) return to;
    if (to == null) to = new HolidayCheckDO();
    to.setId(from.getId());
  ...
  public static HolidayCheck convert(HolidayCheckDO from, HolidayCheck to) {
    if (from == null) return to;
