...
public class HolidayCheckDetailMapper {
  public String id;
  ...
  public Map holiday = null;

  public Map user = null;

  public HolidayCheckDetailMapper() {
  }

  public HolidayCheckDetailMapper(String id, String holidayId, String approverId, Integer status,
  ...
  public static HolidayCheckDetailMapper buildMapper(HolidayCheck obj) {
    HolidayCheckDetailMapper mapper = new HolidayCheckDetailMapper();
    mapper.id=obj.getId();
  ...
  public static Map<String, Object> buildMapExtra(HolidayCheck obj, Map<String, Object> holiday,
  ...
  public static Map<String, String> buildSerialMapExtra(HolidayCheck obj,
      Map<String, Object> holiday, Map<String, Object> user) {
    Map<String, String> map = buildSerialMap(obj);
    if (obj == null) return map;
    map.put("holiday", JSONObject.toJSONString(holiday));
