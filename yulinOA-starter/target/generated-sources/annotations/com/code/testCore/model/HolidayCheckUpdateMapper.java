...
public class HolidayCheckUpdateMapper {
  public String id;
  ...
  public HolidayCheckUpdateMapper() {
  }

  public HolidayCheckUpdateMapper(String id, String holidayId, String approverId, Integer status) {
    this.id=id;
  ...
  public static HolidayCheckUpdateMapper buildMapper(HolidayCheck obj) {
    HolidayCheckUpdateMapper mapper = new HolidayCheckUpdateMapper();
    mapper.id=obj.getId();
