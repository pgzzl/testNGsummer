...
public class HolidayDefaultMapper {
  public String id;
  ...
  public HolidayDefaultMapper() {
  }

  public HolidayDefaultMapper(String id, String holidayClass, Date hilidayStartTime,
      Date holidayEndTime, String holidayReason, String userId, String status, Date gmtUpdate,
      Date gmtCreate) {
    this.id=id;
  ...
  public static HolidayDefaultMapper buildMapper(Holiday obj) {
    HolidayDefaultMapper mapper = new HolidayDefaultMapper();
    mapper.id=obj.getId();
