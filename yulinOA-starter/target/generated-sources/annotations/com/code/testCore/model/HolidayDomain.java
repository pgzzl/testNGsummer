...
public class HolidayDomain {
  ...
  public HolidayDomain(String id, String holidayClass, Date hilidayStartTime, Date holidayEndTime,
  ...
  public static HolidayDomain buildMapper(Holiday obj) {
    HolidayDomain mapper = new HolidayDomain();
    mapper.id=obj.getId();
  ...
  public static HolidayTO convert(Holiday from, HolidayTO to) {
    if (from == null) return to;
    if (to == null) to = new HolidayTO();
    to.setId(from.getId());
  ...
  public static Holiday convert(HolidayTO from, Holiday to) {
    if (from == null) return to;
