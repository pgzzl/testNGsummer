...
public class HolidaySimpleMapper {
  public String id;
  ...
  public HolidaySimpleMapper() {
  }

  public HolidaySimpleMapper(String id, String holidayClass, Long hilidayStartTime,
  ...
  public static HolidaySimpleMapper buildMapper(Holiday obj) {
    HolidaySimpleMapper mapper = new HolidaySimpleMapper();
    mapper.id=obj.getId();
