...
public class InJobData {
  ...
  public InJobData(String id, String userId, String phone, String idCard, String department,
  ...
  public static InJobData buildMapper(InJob obj) {
    InJobData mapper = new InJobData();
    mapper.id=obj.getId();
  ...
  public static InJobDO convert(InJob from, InJobDO to) {
    if (from == null) return to;
    if (to == null) to = new InJobDO();
    to.setId(from.getId());
  ...
  public static InJob convert(InJobDO from, InJob to) {
    if (from == null) return to;
