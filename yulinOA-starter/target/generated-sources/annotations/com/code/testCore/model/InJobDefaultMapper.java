...
public class InJobDefaultMapper {
  public String id;
  ...
  public InJobDefaultMapper() {
  }

  public InJobDefaultMapper(String id, String userId, String phone, String idCard,
      String department, String position, String email, String inJobRemark, String approver,
  ...
  public static InJobDefaultMapper buildMapper(InJob obj) {
    InJobDefaultMapper mapper = new InJobDefaultMapper();
    mapper.id=obj.getId();
