...
public class InJobDetailMapper {
  public String id;
  ...
  public InJobDetailMapper() {
  }

  public InJobDetailMapper(String id, String userId, String phone, String idCard, String department,
  ...
  public static InJobDetailMapper buildMapper(InJob obj) {
    InJobDetailMapper mapper = new InJobDetailMapper();
    mapper.id=obj.getId();
  ...
  public static Map<String, Object> buildMapExtra(InJob obj, Map<String, Object> user) {
  ...
  public static Map<String, String> buildSerialMapExtra(InJob obj, Map<String, Object> user) {
