...
public class InJobDomain {
  ...
  public InJobDomain(String id, String userId, String phone, String idCard, String department,
  ...
  public static InJobDomain buildMapper(InJob obj) {
    InJobDomain mapper = new InJobDomain();
    mapper.id=obj.getId();
  ...
  public static InJobTO convert(InJob from, InJobTO to) {
    if (from == null) return to;
    if (to == null) to = new InJobTO();
    to.setId(from.getId());
    to.setUserId(from.getUserId());
    to.setPhone(from.getPhone());
    to.setIdCard(from.getIdCard());
    to.setDepartment(from.getDepartment());
    to.setPosition(from.getPosition());
    to.setEmail(from.getEmail());
    to.setInJobRemark(from.getInJobRemark());
    to.setApprover(from.getApprover());
  ...
  public static InJob convert(InJobTO from, InJob to) {
    if (from == null) return to;
    if (to == null) to = new InJob();
    to.setId(from.getId());
    to.setUserId(from.getUserId());
    to.setPhone(from.getPhone());
    to.setIdCard(from.getIdCard());
