...
public class InJobPostMapper {
  ...
  public InJobPostMapper() {
  }

  public InJobPostMapper(String userId, String phone, String idCard, String department,
  ...
  public static InJobPostMapper buildMapper(InJob obj) {
    InJobPostMapper mapper = new InJobPostMapper();
