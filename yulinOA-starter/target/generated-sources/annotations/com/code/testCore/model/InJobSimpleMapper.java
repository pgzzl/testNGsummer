...
public class InJobSimpleMapper {
  public String id;
  ...
  public InJobSimpleMapper() {
  }

  public InJobSimpleMapper(String id, String userId, String phone, String idCard, String department,
  ...
  public static InJobSimpleMapper buildMapper(InJob obj) {
    InJobSimpleMapper mapper = new InJobSimpleMapper();
    mapper.id=obj.getId();
