...
public class KnowledgeDefaultMapper {
  public String id;
  ...
  public KnowledgeDefaultMapper() {
  }

  public KnowledgeDefaultMapper(String id, String knowledgeName, String upload, String lookUp,
  ...
  public static KnowledgeDefaultMapper buildMapper(Knowledge obj) {
    KnowledgeDefaultMapper mapper = new KnowledgeDefaultMapper();
    mapper.id=obj.getId();
