...
public class KnowledgeDomain {
  ...
  public KnowledgeDomain(String id, String knowledgeName, String upload, String lookUp,
  ...
  public static KnowledgeDomain buildMapper(Knowledge obj) {
    KnowledgeDomain mapper = new KnowledgeDomain();
    mapper.id=obj.getId();
  ...
  public static KnowledgeTO convert(Knowledge from, KnowledgeTO to) {
    if (from == null) return to;
    if (to == null) to = new KnowledgeTO();
    to.setId(from.getId());
  ...
  public static Knowledge convert(KnowledgeTO from, Knowledge to) {
    if (from == null) return to;
