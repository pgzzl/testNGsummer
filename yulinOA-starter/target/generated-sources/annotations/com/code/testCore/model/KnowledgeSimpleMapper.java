...
public class KnowledgeSimpleMapper {
  public String id;
  ...
  public KnowledgeSimpleMapper() {
  }

  public KnowledgeSimpleMapper(String id, String knowledgeName, String upload, String lookUp,
  ...
  public static KnowledgeSimpleMapper buildMapper(Knowledge obj) {
    KnowledgeSimpleMapper mapper = new KnowledgeSimpleMapper();
    mapper.id=obj.getId();
