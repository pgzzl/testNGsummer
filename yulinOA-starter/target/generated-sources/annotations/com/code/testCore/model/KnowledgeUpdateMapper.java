...
public class KnowledgeUpdateMapper {
  public String id;
  ...
  public KnowledgeUpdateMapper() {
  }

  public KnowledgeUpdateMapper(String id, String knowledgeName, String upload, String lookUp,
      String describe, String contentDetail, String accessory, Long uploadTime) {
    this.id=id;
  ...
  public static KnowledgeUpdateMapper buildMapper(Knowledge obj) {
    KnowledgeUpdateMapper mapper = new KnowledgeUpdateMapper();
    mapper.id=obj.getId();
