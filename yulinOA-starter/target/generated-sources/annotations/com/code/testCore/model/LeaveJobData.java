...
public class LeaveJobData {
  ...
  public LeaveJobData(String id, String userId, String position, Date applyLeaveTime,
  ...
  public static LeaveJobData buildMapper(LeaveJob obj) {
    LeaveJobData mapper = new LeaveJobData();
    mapper.id=obj.getId();
  ...
  public static LeaveJobDO convert(LeaveJob from, LeaveJobDO to) {
    if (from == null) return to;
    if (to == null) to = new LeaveJobDO();
    to.setId(from.getId());
  ...
  public static LeaveJob convert(LeaveJobDO from, LeaveJob to) {
    if (from == null) return to;
