...
public class LeaveJobDetailMapper {
  public String id;
  ...
  public LeaveJobDetailMapper() {
  }

  public LeaveJobDetailMapper(String id, String userId, String position, Long applyLeaveTime,
  ...
  public static LeaveJobDetailMapper buildMapper(LeaveJob obj) {
    LeaveJobDetailMapper mapper = new LeaveJobDetailMapper();
    mapper.id=obj.getId();
  ...
  public static Map<String, Object> buildMapExtra(LeaveJob obj, Map<String, Object> user) {
  ...
  public static Map<String, String> buildSerialMapExtra(LeaveJob obj, Map<String, Object> user) {
