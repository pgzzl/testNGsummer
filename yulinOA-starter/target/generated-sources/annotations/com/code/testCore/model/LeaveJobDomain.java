...
public class LeaveJobDomain {
  ...
  public LeaveJobDomain() {
  }

  public LeaveJobDomain(String id, String userId, String position, Date applyLeaveTime,
  ...
  public static LeaveJobDomain buildMapper(LeaveJob obj) {
    LeaveJobDomain mapper = new LeaveJobDomain();
    mapper.id=obj.getId();
  ...
  public static LeaveJobTO convert(LeaveJob from, LeaveJobTO to) {
    if (from == null) return to;
    if (to == null) to = new LeaveJobTO();
    to.setId(from.getId());
    to.setUserId(from.getUserId());
    to.setPosition(from.getPosition());
    to.setApplyLeaveTime(from.getApplyLeaveTime());
    to.setLeaveReason(from.getLeaveReason());
    to.setLeaveRemark(from.getLeaveRemark());
  ...
  public static LeaveJob convert(LeaveJobTO from, LeaveJob to) {
    if (from == null) return to;
    if (to == null) to = new LeaveJob();
    to.setId(from.getId());
    to.setUserId(from.getUserId());
    to.setPosition(from.getPosition());
    to.setApplyLeaveTime(from.getApplyLeaveTime());
