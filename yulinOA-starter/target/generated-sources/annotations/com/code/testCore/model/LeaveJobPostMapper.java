...
public class LeaveJobPostMapper {
  ...
  public LeaveJobPostMapper() {
  }

  public LeaveJobPostMapper(String userId, String position, Long applyLeaveTime, String leaveReason,
  ...
  public static LeaveJobPostMapper buildMapper(LeaveJob obj) {
    LeaveJobPostMapper mapper = new LeaveJobPostMapper();
