...
public class MeetingDefaultMapper {
  public String id;
  ...
  public MeetingDefaultMapper() {
  }

  public MeetingDefaultMapper(String id, String applyPeople, String enterpriseId,
      String meetingRoomId, String meetingTitle, Integer joinMeetingNum, Date meetingTime,
  ...
  public static MeetingDefaultMapper buildMapper(Meeting obj) {
    MeetingDefaultMapper mapper = new MeetingDefaultMapper();
    mapper.id=obj.getId();
