...
public class MeetingDomain {
  ...
  public MeetingDomain(String id, String applyPeople, String enterpriseId, String meetingRoomId,
  ...
  public static MeetingDomain buildMapper(Meeting obj) {
    MeetingDomain mapper = new MeetingDomain();
    mapper.id=obj.getId();
  ...
  public static MeetingTO convert(Meeting from, MeetingTO to) {
    if (from == null) return to;
    if (to == null) to = new MeetingTO();
    to.setId(from.getId());
  ...
  public static Meeting convert(MeetingTO from, Meeting to) {
    if (from == null) return to;
