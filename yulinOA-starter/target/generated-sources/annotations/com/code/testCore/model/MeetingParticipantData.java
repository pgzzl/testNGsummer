...
public class MeetingParticipantData {
  ...
  public MeetingParticipantData() {
  }

  public MeetingParticipantData(String id, String meetingId, String userId, Integer status,
  ...
  public static MeetingParticipantData buildMapper(MeetingParticipant obj) {
    MeetingParticipantData mapper = new MeetingParticipantData();
    mapper.id=obj.getId();
  ...
  public static MeetingParticipantDO convert(MeetingParticipant from, MeetingParticipantDO to) {
    if (from == null) return to;
    if (to == null) to = new MeetingParticipantDO();
    to.setId(from.getId());
  ...
  public static MeetingParticipant convert(MeetingParticipantDO from, MeetingParticipant to) {
    if (from == null) return to;
