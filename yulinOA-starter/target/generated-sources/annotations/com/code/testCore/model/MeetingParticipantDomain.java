...
public class MeetingParticipantDomain {
  public String id;
  ...
  public MeetingParticipantDomain() {
  }

  public MeetingParticipantDomain(String id, String meetingId, String userId, Integer status,
  ...
  public static MeetingParticipantDomain buildMapper(MeetingParticipant obj) {
    MeetingParticipantDomain mapper = new MeetingParticipantDomain();
    mapper.id=obj.getId();
  ...
  public static MeetingParticipantTO convert(MeetingParticipant from, MeetingParticipantTO to) {
    if (from == null) return to;
    if (to == null) to = new MeetingParticipantTO();
    to.setId(from.getId());
  ...
  public static MeetingParticipant convert(MeetingParticipantTO from, MeetingParticipant to) {
    if (from == null) return to;
    if (to == null) to = new MeetingParticipant();
    to.setId(from.getId());
    to.setMeetingId(from.getMeetingId());
    to.setUserId(from.getUserId());
    to.setStatus(from.getStatus());
