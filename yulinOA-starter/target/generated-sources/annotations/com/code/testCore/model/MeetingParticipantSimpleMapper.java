...
public class MeetingParticipantSimpleMapper {
  public String id;
  ...
  public MeetingParticipantSimpleMapper() {
  }

  public MeetingParticipantSimpleMapper(String id, String meetingId, String userId, Integer status,
  ...
  public static MeetingParticipantSimpleMapper buildMapper(MeetingParticipant obj) {
    MeetingParticipantSimpleMapper mapper = new MeetingParticipantSimpleMapper();
    mapper.id=obj.getId();
