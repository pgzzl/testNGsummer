...
public class MeetingPostMapper {
  ...
  public MeetingPostMapper() {
  }

  public MeetingPostMapper(String applyPeople, String enterpriseId, String meetingTitle,
      Integer joinMeetingNum, Long meetingTime, String meetingAddress, String meetingExplain,
      Integer audiState, String audiRemark) {
  ...
  public static MeetingPostMapper buildMapper(Meeting obj) {
    MeetingPostMapper mapper = new MeetingPostMapper();
