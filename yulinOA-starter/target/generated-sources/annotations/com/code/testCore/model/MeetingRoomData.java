...
public class MeetingRoomData {
  ...
  public MeetingRoomData(String id, String roomName, String roomFacility, Integer roomState,
  ...
  public static MeetingRoomData buildMapper(MeetingRoom obj) {
    MeetingRoomData mapper = new MeetingRoomData();
    mapper.id=obj.getId();
  ...
  public static MeetingRoomDO convert(MeetingRoom from, MeetingRoomDO to) {
    if (from == null) return to;
    if (to == null) to = new MeetingRoomDO();
    to.setId(from.getId());
  ...
  public static MeetingRoom convert(MeetingRoomDO from, MeetingRoom to) {
    if (from == null) return to;
