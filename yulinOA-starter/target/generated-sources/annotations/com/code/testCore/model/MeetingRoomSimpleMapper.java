...
public class MeetingRoomSimpleMapper {
  public String id;
  ...
  public MeetingRoomSimpleMapper() {
  }

  public MeetingRoomSimpleMapper(String id, String roomName, String roomFacility, Integer roomState,
  ...
  public static MeetingRoomSimpleMapper buildMapper(MeetingRoom obj) {
    MeetingRoomSimpleMapper mapper = new MeetingRoomSimpleMapper();
    mapper.id=obj.getId();
