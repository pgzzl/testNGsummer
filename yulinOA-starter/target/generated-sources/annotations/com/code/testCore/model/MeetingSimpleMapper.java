...
public class MeetingSimpleMapper {
  public String id;
  ...
  public MeetingSimpleMapper() {
  }

  public MeetingSimpleMapper(String id, String applyPeople, String enterpriseId,
  ...
  public static MeetingSimpleMapper buildMapper(Meeting obj) {
    MeetingSimpleMapper mapper = new MeetingSimpleMapper();
    mapper.id=obj.getId();
