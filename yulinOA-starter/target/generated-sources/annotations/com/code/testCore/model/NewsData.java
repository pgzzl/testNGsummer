...
public class NewsData {
  ...
  public NewsData(String id, String newsTitle, String publisher, Date releaseTime,
  ...
  public static NewsData buildMapper(News obj) {
    NewsData mapper = new NewsData();
    mapper.id=obj.getId();
  ...
  public static NewsDO convert(News from, NewsDO to) {
    if (from == null) return to;
    if (to == null) to = new NewsDO();
    to.setId(from.getId());
  ...
  public static News convert(NewsDO from, News to) {
    if (from == null) return to;
