...
public class NewsDefaultMapper {
  public String id;
  ...
  public NewsDefaultMapper() {
  }

  public NewsDefaultMapper(String id, String newsTitle, String publisher, Date releaseTime,
  ...
  public static NewsDefaultMapper buildMapper(News obj) {
    NewsDefaultMapper mapper = new NewsDefaultMapper();
    mapper.id=obj.getId();
