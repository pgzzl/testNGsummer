...
public class NewsDetailMapper {
  ...
  public NewsDetailMapper() {
  }

  public NewsDetailMapper(String id, String newsTitle, String publisher, Long releaseTime,
  ...
  public static NewsDetailMapper buildMapper(News obj) {
    NewsDetailMapper mapper = new NewsDetailMapper();
    mapper.id=obj.getId();
