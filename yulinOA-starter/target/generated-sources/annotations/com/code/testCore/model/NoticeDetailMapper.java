...
public class NoticeDetailMapper {
  ...
  public List<Map> noticeEnterpriseList = null;

  public NoticeDetailMapper() {
  }

  public NoticeDetailMapper(String id, String noticeTitle, String issuer, Long issueTime,
  ...
  public static NoticeDetailMapper buildMapper(Notice obj) {
    NoticeDetailMapper mapper = new NoticeDetailMapper();
    mapper.id=obj.getId();
  ...
  public Map<String, Object> buildMap() {
    ...
    map.put("noticeEnterpriseList",this.noticeEnterpriseList);
    return map;
  }
  ...
  public static Map<String, Object> buildMapExtra(Notice obj,
      List<Map<String, Object>> noticeEnterpriseList) {
    Map<String, Object> map = buildMap(obj);
    if (obj == null) return map;
    map.put("noticeEnterpriseList", noticeEnterpriseList);
    return map;
  }

  public static Map<String, String> buildSerialMapExtra(Notice obj,
      List<Map<String, Object>> noticeEnterpriseList) {
    Map<String, String> map = buildSerialMap(obj);
    if (obj == null) return map;
    map.put("noticeEnterpriseList", JSONObject.toJSONString(noticeEnterpriseList));
    return map;
  }
}
