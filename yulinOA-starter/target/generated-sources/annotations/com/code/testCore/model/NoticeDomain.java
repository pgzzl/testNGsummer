...
public class NoticeDomain {
  ...
  public NoticeDomain(String id, String noticeTitle, String issuer, Date issueTime,
  ...
  public static NoticeDomain buildMapper(Notice obj) {
    NoticeDomain mapper = new NoticeDomain();
    mapper.id=obj.getId();
  ...
  public static NoticeTO convert(Notice from, NoticeTO to) {
    if (from == null) return to;
    if (to == null) to = new NoticeTO();
    to.setId(from.getId());
  ...
  public static Notice convert(NoticeTO from, Notice to) {
    if (from == null) return to;
