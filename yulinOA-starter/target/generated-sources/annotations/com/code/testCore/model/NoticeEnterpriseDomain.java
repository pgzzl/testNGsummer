...
public class NoticeEnterpriseDomain {
  public String id;
  ...
  public NoticeEnterpriseDomain() {
  }

  public NoticeEnterpriseDomain(String id, String noticeId, String enterpriseId, Date gmtUpdate,
      Date gmtCreate) {
    this.id=id;
  ...
  public static NoticeEnterpriseDomain buildMapper(NoticeEnterprise obj) {
    NoticeEnterpriseDomain mapper = new NoticeEnterpriseDomain();
    mapper.id=obj.getId();
  ...
  public static NoticeEnterpriseTO convert(NoticeEnterprise from, NoticeEnterpriseTO to) {
    if (from == null) return to;
    if (to == null) to = new NoticeEnterpriseTO();
    to.setId(from.getId());
  ...
  public static NoticeEnterprise convert(NoticeEnterpriseTO from, NoticeEnterprise to) {
    if (from == null) return to;
