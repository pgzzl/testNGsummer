...
public class NoticeEnterpriseSimpleMapper {
  public String id;
  ...
  public NoticeEnterpriseSimpleMapper() {
  }

  public NoticeEnterpriseSimpleMapper(String id, String noticeId, String enterpriseId,
  ...
  public static NoticeEnterpriseSimpleMapper buildMapper(NoticeEnterprise obj) {
    NoticeEnterpriseSimpleMapper mapper = new NoticeEnterpriseSimpleMapper();
    mapper.id=obj.getId();
