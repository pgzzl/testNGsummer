...
public class NoticeUpdateMapper {
  public String id;
  ...
  public NoticeUpdateMapper() {
  }

  public NoticeUpdateMapper(String id, String noticeTitle, String issuer, Long issueTime,
      String accessory, String detail, String noticeImg) {
    this.id=id;
  ...
  public static NoticeUpdateMapper buildMapper(Notice obj) {
    NoticeUpdateMapper mapper = new NoticeUpdateMapper();
    mapper.id=obj.getId();
