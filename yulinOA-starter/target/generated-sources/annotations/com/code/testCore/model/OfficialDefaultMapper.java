...
public class OfficialDefaultMapper {
  public String id;
  ...
  public OfficialDefaultMapper() {
  }

  public OfficialDefaultMapper(String id, String officialTitle, Date sendTime, String sentObj,
  ...
  public static OfficialDefaultMapper buildMapper(Official obj) {
    OfficialDefaultMapper mapper = new OfficialDefaultMapper();
    mapper.id=obj.getId();
