...
public class OfficialDetailMapper {
  public String id;
  ...
  public OfficialDetailMapper() {
  }

  public OfficialDetailMapper(String id, String officialTitle, Long sendTime, String sentObj,
  ...
  public static OfficialDetailMapper buildMapper(Official obj) {
    OfficialDetailMapper mapper = new OfficialDetailMapper();
    mapper.id=obj.getId();
  ...
  public static Map<String, Object> buildMapExtra(Official obj, Map<String, Object> sealManage) {
  ...
  public static Map<String, String> buildSerialMapExtra(Official obj,
      Map<String, Object> sealManage) {
