...
public class OfficialDomain {
  ...
  public OfficialDomain() {
  }

  public OfficialDomain(String id, String officialTitle, Date sendTime, String sentObj,
  ...
  public static OfficialDomain buildMapper(Official obj) {
    OfficialDomain mapper = new OfficialDomain();
    mapper.id=obj.getId();
  ...
  public static OfficialTO convert(Official from, OfficialTO to) {
    if (from == null) return to;
    if (to == null) to = new OfficialTO();
    to.setId(from.getId());
  ...
  public static Official convert(OfficialTO from, Official to) {
    if (from == null) return to;
