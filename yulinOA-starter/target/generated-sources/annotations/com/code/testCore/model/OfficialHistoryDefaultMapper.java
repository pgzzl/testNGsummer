...
public class OfficialHistoryDefaultMapper {
  public String id;
  ...
  public OfficialHistoryDefaultMapper() {
  }

  public OfficialHistoryDefaultMapper(String id, String operateClass, String operatePeople,
      Integer result, String remark, String officialId, Date gmtUpdate, Date gmtCreate) {
    this.id=id;
  ...
  public static OfficialHistoryDefaultMapper buildMapper(OfficialHistory obj) {
    OfficialHistoryDefaultMapper mapper = new OfficialHistoryDefaultMapper();
    mapper.id=obj.getId();
