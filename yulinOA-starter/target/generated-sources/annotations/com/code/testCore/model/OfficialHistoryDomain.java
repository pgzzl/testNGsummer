...
public class OfficialHistoryDomain {
  public String id;
  ...
  public OfficialHistoryDomain() {
  }

  public OfficialHistoryDomain(String id, String operateClass, String operatePeople, Integer result,
  ...
  public static OfficialHistoryDomain buildMapper(OfficialHistory obj) {
    OfficialHistoryDomain mapper = new OfficialHistoryDomain();
    mapper.id=obj.getId();
  ...
  public static OfficialHistoryTO convert(OfficialHistory from, OfficialHistoryTO to) {
    if (from == null) return to;
    if (to == null) to = new OfficialHistoryTO();
    to.setId(from.getId());
  ...
  public static OfficialHistory convert(OfficialHistoryTO from, OfficialHistory to) {
    if (from == null) return to;
