...
public class OfficialHistorySimpleMapper {
  public String id;
  ...
  public OfficialHistorySimpleMapper() {
  }

  public OfficialHistorySimpleMapper(String id, String operateClass, String operatePeople,
  ...
  public static OfficialHistorySimpleMapper buildMapper(OfficialHistory obj) {
    OfficialHistorySimpleMapper mapper = new OfficialHistorySimpleMapper();
    mapper.id=obj.getId();
