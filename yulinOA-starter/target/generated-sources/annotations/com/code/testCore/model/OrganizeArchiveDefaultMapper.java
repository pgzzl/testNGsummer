...
public class OrganizeArchiveDefaultMapper {
  public String id;
  ...
  public OrganizeArchiveDefaultMapper() {
  }

  public OrganizeArchiveDefaultMapper(String id, String archiveId, String organizeId,
  ...
  public static OrganizeArchiveDefaultMapper buildMapper(OrganizeArchive obj) {
    OrganizeArchiveDefaultMapper mapper = new OrganizeArchiveDefaultMapper();
    mapper.id=obj.getId();
