...
public class ParkParkData {
  ...
  public ParkParkData(String id, String parkName, Integer allStall, String place,
  ...
  public static ParkParkData buildMapper(ParkPark obj) {
    ParkParkData mapper = new ParkParkData();
    mapper.id=obj.getId();
  ...
  public static ParkParkDO convert(ParkPark from, ParkParkDO to) {
    if (from == null) return to;
    if (to == null) to = new ParkParkDO();
    to.setId(from.getId());
  ...
  public static ParkPark convert(ParkParkDO from, ParkPark to) {
    if (from == null) return to;
