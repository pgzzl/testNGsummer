...
public class ParkParkSimpleMapper {
  public String id;
  ...
  public ParkParkSimpleMapper() {
  }

  public ParkParkSimpleMapper(String id, String parkName, Integer allStall, String place,
  ...
  public static ParkParkSimpleMapper buildMapper(ParkPark obj) {
    ParkParkSimpleMapper mapper = new ParkParkSimpleMapper();
    mapper.id=obj.getId();
