...
public class ParkParkUpdateMapper {
  public String id;
  ...
  public ParkParkUpdateMapper() {
  }

  public ParkParkUpdateMapper(String id, String parkName, Integer allStall, String place,
  ...
  public static ParkParkUpdateMapper buildMapper(ParkPark obj) {
    ParkParkUpdateMapper mapper = new ParkParkUpdateMapper();
    mapper.id=obj.getId();
