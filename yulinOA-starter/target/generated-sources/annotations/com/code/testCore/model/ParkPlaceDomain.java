...
import com.horsecoder.yulinOA.sys.domain.ParkPlaceTO;
...
public class ParkPlaceDomain {
  ...
  public ParkPlaceDomain() {
  }

  public ParkPlaceDomain(String id, String parkParkId, String name, Date gmtUpdate,
      Date gmtCreate) {
    this.id=id;
  ...
  public static ParkPlaceDomain buildMapper(ParkPlace obj) {
    ParkPlaceDomain mapper = new ParkPlaceDomain();
    mapper.id=obj.getId();
  ...
  public static ParkPlaceTO convert(ParkPlace from, ParkPlaceTO to) {
    if (from == null) return to;
    if (to == null) to = new ParkPlaceTO();
    to.setId(from.getId());
  ...
  public static ParkPlace convert(ParkPlaceTO from, ParkPlace to) {
    if (from == null) return to;
