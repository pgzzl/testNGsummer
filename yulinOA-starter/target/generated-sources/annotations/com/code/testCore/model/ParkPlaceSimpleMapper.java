...
public class ParkPlaceSimpleMapper {
  public String id;
  ...
  public ParkPlaceSimpleMapper() {
  }

  public ParkPlaceSimpleMapper(String id, String parkParkId, String name, Long gmtUpdate,
      Long gmtCreate) {
    this.id=id;
  ...
  public static ParkPlaceSimpleMapper buildMapper(ParkPlace obj) {
    ParkPlaceSimpleMapper mapper = new ParkPlaceSimpleMapper();
    mapper.id=obj.getId();
