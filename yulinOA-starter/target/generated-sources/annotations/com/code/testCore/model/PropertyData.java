...
public class PropertyData {
  ...
  public PropertyData(String id, String firmName, String rentPlace, String linkman,
  ...
  public static PropertyData buildMapper(Property obj) {
    PropertyData mapper = new PropertyData();
    mapper.id=obj.getId();
  ...
  public static PropertyDO convert(Property from, PropertyDO to) {
    if (from == null) return to;
    if (to == null) to = new PropertyDO();
    to.setId(from.getId());
  ...
  public static Property convert(PropertyDO from, Property to) {
    if (from == null) return to;
