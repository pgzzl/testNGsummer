...
public class PropertyDefaultMapper {
  public String id;
  ...
  public PropertyDefaultMapper() {
  }

  public PropertyDefaultMapper(String id, String firmName, String rentPlace, String linkman,
  ...
  public static PropertyDefaultMapper buildMapper(Property obj) {
    PropertyDefaultMapper mapper = new PropertyDefaultMapper();
    mapper.id=obj.getId();
