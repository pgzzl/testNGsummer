...
public class PropertyDetailMapper {
  ...
  public List<Map> propertyRecordList = null;
  ...
  public PropertyDetailMapper(String id, String firmName, String rentPlace, String linkman,
  ...
  public static PropertyDetailMapper buildMapper(Property obj) {
    PropertyDetailMapper mapper = new PropertyDetailMapper();
    mapper.id=obj.getId();
  ...
  public Map<String, Object> buildMap() {
    ...
    map.put("propertyRecordList",this.propertyRecordList);
  ...
  public static Map<String, Object> buildMapExtra(Property obj,
      List<Map<String, Object>> propertyRecordList, Map<String, Object> enterprise) {
    Map<String, Object> map = buildMap(obj);
    if (obj == null) return map;
    map.put("propertyRecordList", propertyRecordList);
    map.put("enterprise", enterprise);
    return map;
  }

  public static Map<String, String> buildSerialMapExtra(Property obj,
      List<Map<String, Object>> propertyRecordList, Map<String, Object> enterprise) {
    Map<String, String> map = buildSerialMap(obj);
    if (obj == null) return map;
    map.put("propertyRecordList", JSONObject.toJSONString(propertyRecordList));
