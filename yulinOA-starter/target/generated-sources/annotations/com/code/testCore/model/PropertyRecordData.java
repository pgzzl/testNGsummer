...
public class PropertyRecordData {
  ...
  public PropertyRecordData() {
  }

  public PropertyRecordData(String id, String payPeople, String payPhone, Integer payNum,
  ...
  public static PropertyRecordData buildMapper(PropertyRecord obj) {
    PropertyRecordData mapper = new PropertyRecordData();
    mapper.id=obj.getId();
  ...
  public static PropertyRecordDO convert(PropertyRecord from, PropertyRecordDO to) {
    if (from == null) return to;
    if (to == null) to = new PropertyRecordDO();
    to.setId(from.getId());
  ...
  public static PropertyRecord convert(PropertyRecordDO from, PropertyRecord to) {
    if (from == null) return to;
