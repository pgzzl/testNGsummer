...
public class PropertyRecordDetailMapper {
  public String id;
  ...
  public PropertyRecordDetailMapper() {
  }

  public PropertyRecordDetailMapper(String id, String payPeople, String payPhone, Integer payNum,
  ...
  public static PropertyRecordDetailMapper buildMapper(PropertyRecord obj) {
    PropertyRecordDetailMapper mapper = new PropertyRecordDetailMapper();
    mapper.id=obj.getId();
  ...
  public static Map<String, Object> buildMapExtra(PropertyRecord obj,
  ...
  public static Map<String, String> buildSerialMapExtra(PropertyRecord obj,
      Map<String, Object> property) {
    Map<String, String> map = buildSerialMap(obj);
    if (obj == null) return map;
    map.put("property", JSONObject.toJSONString(property));
    return map;
  }
}
