...
public class PropertyUpdateMapper {
  public String id;
  ...
  public PropertyUpdateMapper() {
  }

  public PropertyUpdateMapper(String id, String firmName, String rentPlace, String linkman,
  ...
  public static PropertyUpdateMapper buildMapper(Property obj) {
    PropertyUpdateMapper mapper = new PropertyUpdateMapper();
    mapper.id=obj.getId();
