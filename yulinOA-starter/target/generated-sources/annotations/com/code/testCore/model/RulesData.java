...
public class RulesData {
  ...
  public RulesData(String id, String rulesTitle, Date releaseTime, Date executeTime, String userId,
  ...
  public static RulesData buildMapper(Rules obj) {
    RulesData mapper = new RulesData();
    mapper.id=obj.getId();
  ...
  public static RulesDO convert(Rules from, RulesDO to) {
    if (from == null) return to;
    if (to == null) to = new RulesDO();
    to.setId(from.getId());
  ...
  public static Rules convert(RulesDO from, Rules to) {
    if (from == null) return to;
