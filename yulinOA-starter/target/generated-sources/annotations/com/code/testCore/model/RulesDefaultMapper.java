...
public class RulesDefaultMapper {
  public String id;
  ...
  public RulesDefaultMapper() {
  }

  public RulesDefaultMapper(String id, String rulesTitle, Date releaseTime, Date executeTime,
  ...
  public static RulesDefaultMapper buildMapper(Rules obj) {
    RulesDefaultMapper mapper = new RulesDefaultMapper();
    mapper.id=obj.getId();
