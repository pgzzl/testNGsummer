...
public class RulesExecuteDefaultMapper {
  public String id;
  ...
  public RulesExecuteDefaultMapper() {
  }

  public RulesExecuteDefaultMapper(String id, String rulesId, String departmentId, Date gmtUpdate,
      Date gmtCreate) {
    this.id=id;
  ...
  public static RulesExecuteDefaultMapper buildMapper(RulesExecute obj) {
    RulesExecuteDefaultMapper mapper = new RulesExecuteDefaultMapper();
    mapper.id=obj.getId();
