...
public class RulesExecuteDetailMapper {
  public String id;
  ...
  public Map rules = null;

  public RulesExecuteDetailMapper() {
  }

  public RulesExecuteDetailMapper(String id, String rulesId, String departmentId, Long gmtUpdate,
      Long gmtCreate) {
    this.id=id;
  ...
  public static RulesExecuteDetailMapper buildMapper(RulesExecute obj) {
    RulesExecuteDetailMapper mapper = new RulesExecuteDetailMapper();
    mapper.id=obj.getId();
  ...
  public static Map<String, Object> buildMapExtra(RulesExecute obj, Map<String, Object> rules) {
  ...
  public static Map<String, String> buildSerialMapExtra(RulesExecute obj,
      Map<String, Object> rules) {
    Map<String, String> map = buildSerialMap(obj);
    if (obj == null) return map;
    map.put("rules", JSONObject.toJSONString(rules));
    return map;
  }
}
