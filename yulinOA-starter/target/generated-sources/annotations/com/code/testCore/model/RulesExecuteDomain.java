...
public class RulesExecuteDomain {
  public String id;
  ...
  public RulesExecuteDomain() {
  }

  public RulesExecuteDomain(String id, String rulesId, String departmentId, Date gmtUpdate,
      Date gmtCreate) {
    this.id=id;
  ...
  public static RulesExecuteDomain buildMapper(RulesExecute obj) {
    RulesExecuteDomain mapper = new RulesExecuteDomain();
    mapper.id=obj.getId();
  ...
  public static RulesExecuteTO convert(RulesExecute from, RulesExecuteTO to) {
    if (from == null) return to;
    if (to == null) to = new RulesExecuteTO();
    to.setId(from.getId());
  ...
  public static RulesExecute convert(RulesExecuteTO from, RulesExecute to) {
    if (from == null) return to;
