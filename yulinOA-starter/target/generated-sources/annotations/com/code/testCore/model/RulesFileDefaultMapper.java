...
public class RulesFileDefaultMapper {
  public String id;
  ...
  public RulesFileDefaultMapper() {
  }

  public RulesFileDefaultMapper(String id, String fileUrl, String fileName, String rulesId,
  ...
  public static RulesFileDefaultMapper buildMapper(RulesFile obj) {
    RulesFileDefaultMapper mapper = new RulesFileDefaultMapper();
    mapper.id=obj.getId();
