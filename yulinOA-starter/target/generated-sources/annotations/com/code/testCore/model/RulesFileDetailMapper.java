...
public class RulesFileDetailMapper {
  public String id;
  ...
  public RulesFileDetailMapper() {
  }

  public RulesFileDetailMapper(String id, String fileUrl, String fileName, String rulesId,
  ...
  public static RulesFileDetailMapper buildMapper(RulesFile obj) {
    RulesFileDetailMapper mapper = new RulesFileDetailMapper();
    mapper.id=obj.getId();
