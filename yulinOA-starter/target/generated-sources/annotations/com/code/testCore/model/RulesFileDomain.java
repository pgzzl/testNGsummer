...
public class RulesFileDomain {
  ...
  public RulesFileDomain() {
  }

  public RulesFileDomain(String id, String fileUrl, String fileName, String rulesId, Date gmtUpdate,
      Date gmtCreate) {
    this.id=id;
  ...
  public static RulesFileDomain buildMapper(RulesFile obj) {
    RulesFileDomain mapper = new RulesFileDomain();
    mapper.id=obj.getId();
  ...
  public static RulesFileTO convert(RulesFile from, RulesFileTO to) {
    if (from == null) return to;
    if (to == null) to = new RulesFileTO();
    to.setId(from.getId());
  ...
  public static RulesFile convert(RulesFileTO from, RulesFile to) {
    if (from == null) return to;
