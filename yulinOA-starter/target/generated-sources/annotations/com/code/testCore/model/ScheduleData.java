...
public class ScheduleData {
  ...
  public ScheduleData(String id, String userId, Date gmtUpdate, Date gmtCreate) {
    this.id=id;
    this.userId=userId;
  ...
  public static ScheduleData buildMapper(Schedule obj) {
    ScheduleData mapper = new ScheduleData();
    mapper.id=obj.getId();
  ...
  public static ScheduleDO convert(Schedule from, ScheduleDO to) {
    if (from == null) return to;
    if (to == null) to = new ScheduleDO();
    to.setId(from.getId());
  ...
  public static Schedule convert(ScheduleDO from, Schedule to) {
    if (from == null) return to;
