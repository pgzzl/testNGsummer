...
import com.horsecoder.yulinOA.sys.dataobject.ScheduleItemDO;
...
public class ScheduleItemData {
  ...
  public ScheduleItemData(String id, String scheduleId, Date beginDate, Date endDate,
  ...
  public static ScheduleItemData buildMapper(ScheduleItem obj) {
    ScheduleItemData mapper = new ScheduleItemData();
    mapper.id=obj.getId();
  ...
  public static ScheduleItemDO convert(ScheduleItem from, ScheduleItemDO to) {
    if (from == null) return to;
    if (to == null) to = new ScheduleItemDO();
    to.setId(from.getId());
  ...
  public static ScheduleItem convert(ScheduleItemDO from, ScheduleItem to) {
    if (from == null) return to;
