...
import com.horsecoder.yulinOA.sys.domain.ScheduleItemTO;
...
public class ScheduleItemDomain {
  ...
  public ScheduleItemDomain(String id, String scheduleId, Date beginDate, Date endDate,
  ...
  public static ScheduleItemDomain buildMapper(ScheduleItem obj) {
    ScheduleItemDomain mapper = new ScheduleItemDomain();
    mapper.id=obj.getId();
  ...
  public static ScheduleItemTO convert(ScheduleItem from, ScheduleItemTO to) {
    if (from == null) return to;
    if (to == null) to = new ScheduleItemTO();
    to.setId(from.getId());
  ...
  public static ScheduleItem convert(ScheduleItemTO from, ScheduleItem to) {
    if (from == null) return to;
    if (to == null) to = new ScheduleItem();
    to.setId(from.getId());
    to.setScheduleId(from.getScheduleId());
    to.setBeginDate(from.getBeginDate());
    to.setEndDate(from.getEndDate());
