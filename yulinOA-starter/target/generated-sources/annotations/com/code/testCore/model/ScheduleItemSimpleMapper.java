...
public class ScheduleItemSimpleMapper {
  public String id;
  ...
  public ScheduleItemSimpleMapper() {
  }

  public ScheduleItemSimpleMapper(String id, String scheduleId, Long beginDate, Long endDate,
  ...
  public static ScheduleItemSimpleMapper buildMapper(ScheduleItem obj) {
    ScheduleItemSimpleMapper mapper = new ScheduleItemSimpleMapper();
    mapper.id=obj.getId();
