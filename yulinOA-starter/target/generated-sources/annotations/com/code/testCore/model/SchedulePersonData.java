...
import com.horsecoder.yulinOA.sys.dataobject.SchedulePersonDO;
...
public class SchedulePersonData {
  public String id;
  ...
  public SchedulePersonData() {
  }

  public SchedulePersonData(String id, String scheduleId, String userId, Date gmtUpdate,
      Date gmtCreate) {
    this.id=id;
  ...
  public static SchedulePersonData buildMapper(SchedulePerson obj) {
    SchedulePersonData mapper = new SchedulePersonData();
    mapper.id=obj.getId();
  ...
  public static SchedulePersonDO convert(SchedulePerson from, SchedulePersonDO to) {
    if (from == null) return to;
    if (to == null) to = new SchedulePersonDO();
    to.setId(from.getId());
  ...
  public static SchedulePerson convert(SchedulePersonDO from, SchedulePerson to) {
    if (from == null) return to;
