...
public class SchedulePersonDefaultMapper {
  public String id;
  ...
  public SchedulePersonDefaultMapper() {
  }

  public SchedulePersonDefaultMapper(String id, String scheduleId, String userId, Date gmtUpdate,
      Date gmtCreate) {
    this.id=id;
  ...
  public static SchedulePersonDefaultMapper buildMapper(SchedulePerson obj) {
    SchedulePersonDefaultMapper mapper = new SchedulePersonDefaultMapper();
    mapper.id=obj.getId();
