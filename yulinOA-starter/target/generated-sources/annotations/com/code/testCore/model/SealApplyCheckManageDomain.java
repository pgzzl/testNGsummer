...
import com.horsecoder.yulinOA.sys.domain.SealApplyCheckManageTO;
...
public class SealApplyCheckManageDomain {
  public String id;
  ...
  public SealApplyCheckManageDomain() {
  }

  public SealApplyCheckManageDomain(String id, String sealApplyId, String checkPersonId,
  ...
  public static SealApplyCheckManageDomain buildMapper(SealApplyCheckManage obj) {
    SealApplyCheckManageDomain mapper = new SealApplyCheckManageDomain();
    mapper.id=obj.getId();
  ...
  public static SealApplyCheckManageTO convert(SealApplyCheckManage from,
      SealApplyCheckManageTO to) {
    if (from == null) return to;
    if (to == null) to = new SealApplyCheckManageTO();
    to.setId(from.getId());
  ...
  public static SealApplyCheckManage convert(SealApplyCheckManageTO from, SealApplyCheckManage to) {
    if (from == null) return to;
