...
public class SealApplyManageData {
  public String id;
  ...
  public SealApplyManageData() {
  }

  public SealApplyManageData(String id, String applyUserId, String sealId, Date endTime,
  ...
  public static SealApplyManageData buildMapper(SealApplyManage obj) {
    SealApplyManageData mapper = new SealApplyManageData();
    mapper.id=obj.getId();
  ...
  public static SealApplyManageDO convert(SealApplyManage from, SealApplyManageDO to) {
    if (from == null) return to;
    if (to == null) to = new SealApplyManageDO();
    to.setId(from.getId());
  ...
  public static SealApplyManage convert(SealApplyManageDO from, SealApplyManage to) {
    if (from == null) return to;
