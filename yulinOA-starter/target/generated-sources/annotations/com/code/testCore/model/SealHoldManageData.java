...
public class SealHoldManageData {
  public String id;
  ...
  public SealHoldManageData() {
  }

  public SealHoldManageData(String id, String holderId, String archiveId, Date limitEndTime,
  ...
  public static SealHoldManageData buildMapper(SealHoldManage obj) {
    SealHoldManageData mapper = new SealHoldManageData();
    mapper.id=obj.getId();
  ...
  public static SealHoldManageDO convert(SealHoldManage from, SealHoldManageDO to) {
    if (from == null) return to;
    if (to == null) to = new SealHoldManageDO();
    to.setId(from.getId());
  ...
  public static SealHoldManage convert(SealHoldManageDO from, SealHoldManage to) {
    if (from == null) return to;
