...
public class SealHoldManageDomain {
  public String id;
  ...
  public SealHoldManageDomain() {
  }

  public SealHoldManageDomain(String id, String holderId, String archiveId, Date limitEndTime,
      Integer holdLimit, Integer state, Date gmtUpdate, Date gmtCreate) {
    this.id=id;
  ...
  public static SealHoldManageDomain buildMapper(SealHoldManage obj) {
    SealHoldManageDomain mapper = new SealHoldManageDomain();
    mapper.id=obj.getId();
  ...
  public static SealHoldManageTO convert(SealHoldManage from, SealHoldManageTO to) {
    if (from == null) return to;
    if (to == null) to = new SealHoldManageTO();
    to.setId(from.getId());
    to.setHolderId(from.getHolderId());
    to.setArchiveId(from.getArchiveId());
    to.setLimitEndTime(from.getLimitEndTime());
    to.setHoldLimit(from.getHoldLimit());
  ...
  public static SealHoldManage convert(SealHoldManageTO from, SealHoldManage to) {
    if (from == null) return to;
    if (to == null) to = new SealHoldManage();
    to.setId(from.getId());
    to.setHolderId(from.getHolderId());
    to.setArchiveId(from.getArchiveId());
    to.setLimitEndTime(from.getLimitEndTime());
