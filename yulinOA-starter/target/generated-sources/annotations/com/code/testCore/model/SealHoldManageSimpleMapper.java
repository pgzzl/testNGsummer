...
public class SealHoldManageSimpleMapper {
  public String id;
  ...
  public SealHoldManageSimpleMapper() {
  }

  public SealHoldManageSimpleMapper(String id, String holderId, String archiveId, Long limitEndTime,
  ...
  public static SealHoldManageSimpleMapper buildMapper(SealHoldManage obj) {
    SealHoldManageSimpleMapper mapper = new SealHoldManageSimpleMapper();
    mapper.id=obj.getId();
