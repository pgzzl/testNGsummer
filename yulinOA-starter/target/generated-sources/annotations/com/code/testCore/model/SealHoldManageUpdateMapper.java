...
public class SealHoldManageUpdateMapper {
  public String id;
  ...
  public SealHoldManageUpdateMapper() {
  }

  public SealHoldManageUpdateMapper(String id, String holderId, String archiveId, Long limitEndTime,
  ...
  public static SealHoldManageUpdateMapper buildMapper(SealHoldManage obj) {
    SealHoldManageUpdateMapper mapper = new SealHoldManageUpdateMapper();
    mapper.id=obj.getId();
