...
public class SealManageDefaultMapper {
  public String id;
  ...
  public SealManageDefaultMapper() {
  }

  public SealManageDefaultMapper(String id, String name, String number, String pictureUrl,
  ...
  public static SealManageDefaultMapper buildMapper(SealManage obj) {
    SealManageDefaultMapper mapper = new SealManageDefaultMapper();
    mapper.id=obj.getId();
