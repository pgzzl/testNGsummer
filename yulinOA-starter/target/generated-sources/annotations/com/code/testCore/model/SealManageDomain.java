...
public class SealManageDomain {
  ...
  public SealManageDomain() {
  }

  public SealManageDomain(String id, String name, String number, String pictureUrl, Date gmtUpdate,
      Date gmtCreate) {
    this.id=id;
    this.name=name;
    this.number=number;
  ...
  public static SealManageDomain buildMapper(SealManage obj) {
    SealManageDomain mapper = new SealManageDomain();
    mapper.id=obj.getId();
  ...
  public static SealManageTO convert(SealManage from, SealManageTO to) {
    if (from == null) return to;
    if (to == null) to = new SealManageTO();
    to.setId(from.getId());
  ...
  public static SealManage convert(SealManageTO from, SealManage to) {
    if (from == null) return to;
