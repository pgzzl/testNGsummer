...
public class SealManageSimpleMapper {
  public String id;
  ...
  public SealManageSimpleMapper() {
  }

  public SealManageSimpleMapper(String id, String name, String number, String pictureUrl,
  ...
  public static SealManageSimpleMapper buildMapper(SealManage obj) {
    SealManageSimpleMapper mapper = new SealManageSimpleMapper();
    mapper.id=obj.getId();
