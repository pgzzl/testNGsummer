...
public class TaskData {
  ...
  public TaskData(String id, String type, String name, String flowId, String status, Date gmtUpdate,
      Date gmtCreate) {
    this.id=id;
    this.type=type;
    this.name=name;
  ...
  public static TaskData buildMapper(Task obj) {
    TaskData mapper = new TaskData();
    mapper.id=obj.getId();
  ...
  public static TaskDO convert(Task from, TaskDO to) {
    if (from == null) return to;
    if (to == null) to = new TaskDO();
    to.setId(from.getId());
  ...
  public static Task convert(TaskDO from, Task to) {
    if (from == null) return to;
