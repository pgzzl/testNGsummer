...
public class TaskDefaultMapper {
  public String id;
  ...
  public TaskDefaultMapper() {
  }

  public TaskDefaultMapper(String id, String type, String name, String flowId, String status,
  ...
  public static TaskDefaultMapper buildMapper(Task obj) {
    TaskDefaultMapper mapper = new TaskDefaultMapper();
    mapper.id=obj.getId();
