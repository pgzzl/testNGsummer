...
public class TaskSimpleMapper {
  ...
  public TaskSimpleMapper() {
  }

  public TaskSimpleMapper(String id, String type, String name, String flowId, String status,
  ...
  public static TaskSimpleMapper buildMapper(Task obj) {
    TaskSimpleMapper mapper = new TaskSimpleMapper();
    mapper.id=obj.getId();
